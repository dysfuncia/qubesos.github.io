...
def main(translated_dir, lang, yml, mapping, href_filename):
    ...
    log_debug('all permalinks/redirects', perms)
...
if __name__ == '__main__':
    ...
    # for later processing but postprocess_translation.sh 
    ...
    logger_file = 'postprocess_translation.log'
    configure_logging(logger_file)
